...
If ($dieStation<>""){
    ...
    foreach($dieStation as $stat){
        ...
        $sqldruck="select Luftdruck, canvasts from Temperatur where Luftdruck>-999 AND station=$stat AND Luftdruck>-999 AND ts like '$datum%' order by ts asc";
        ...
        $sqlfeuchte="select feuchte, canvasts from Temperatur where feuchte>-999 AND station=$stat AND ts like '$datum%' order by ts asc";
        ...
        $sqltaupunkt="select taupunkt, canvasts from Temperatur where taupunkt>-999 AND station=$stat AND ts like '$datum%' order by ts asc";
        ...
        $sqlAktTemp="select temp20, ts from Temperatur where temp20>-999 AND station=$stat AND ts like '$datum%' order by ts desc limit 1";
        ...
        $sqlAvgTemp="select AVG(temp20) from Temperatur where temp20>-999 AND station=$stat AND ts like '$datum%'";
        ...
        //Min-Temperatur
        $sqlMinTemp="SELECT temp20, ts from Temperatur WHERE temp20=(SELECT MIN(temp20) FROM Temperatur WHERE temp20>-999 AND station=$stat AND ts LIKE '$datum%') AND station=$stat AND ts LIKE '$datum%' limit 1";
        ...
        $sqlAvgDruck="select AVG(Luftdruck) from Temperatur where Luftdruck>-999 AND station=$stat AND ts like '$datum%'";
        ...
        $sqlAvgFeuchte="select AVG(feuchte) from Temperatur where feuchte>-999 AND station=$stat AND ts like '$datum%'";
        ...
        $sqlAvgTau="select AVG(taupunkt) from Temperatur where taupunkt>-999 AND station=$stat AND ts like '$datum%'";
