...
foreach ($stationen as $station) {
    ...
    $urlnow = "https://opendata.dwd.de/climate_environment/CDC/observations_germany/climate/10_minutes/precipitation/now/10minutenwerte_nieder_0".$station."_now.zip";
